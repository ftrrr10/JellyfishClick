...
<body class="bg-gradient-to-b from-blue-100 to-white min-h-screen flex items-center justify-center">
    ...
    <div class="w-full max-w-md bg-white rounded-3xl shadow-2xl p-8 relative">
        ...
        <h2 class="text-center text-2xl font-bold text-gray-800 mb-6">Create Your Account</h2>
        ...
        {{-- GANTI ACTION KE ROUTE REGISTER --}}
        <form method="POST" action="{{ route('register') }}" class="space-y-5">
            ...
            <div>
                <button type="submit"
                        class="w-full bg-indigo-600 text-white py-2 px-4 rounded hover:bg-indigo-700">Register</button>
            </div>
        </form>
