...
@section('content')
    ...
    <form action="{{ route('admin.books.store') }}" method="POST" class="space-y-6 bg-white shadow-xl rounded-xl p-8">
        @csrf
        <div>
        ...
        <div>
            ...
            <input type="text" name="authors" class="w-full border border-gray-300 rounded px-3 py-2" required>
        </div>
        ...
        <div>
            ...
            <input type="number" name="publication_year" class="w-full border border-gray-300 rounded px-3 py-2">
        </div>

        <div>
            <label class="block text-sm font-medium text-gray-700">ISBN</label>
            <input type="text" name="isbn" class="w-full border border-gray-300 rounded px-3 py-2">
        </div>

        <div>
            <label class="block text-sm font-medium text-gray-700">Cover Image URL</label>
            <input type="url" name="image_url" class="w-full border border-gray-300 rounded px-3 py-2">
        </div>

        <div>
            <label class="block text-sm font-medium text-gray-700">Average Rating</label>
            <input type="number" step="0.1" name="average_rating" class="w-full border border-gray-300 rounded px-3 py-2">
        </div>
